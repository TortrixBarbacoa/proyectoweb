...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../../assets/css/cssVer1/style.css">
	<link rel="stylesheet" type="text/css" href="../../assets/css/cssVer1/template.css">
				...
				<div class="col-lg-8 col-md-12 col-sm-9 col-xs-12 form-box text-center">
					...
					<div class="heading mb-3">
						...
						<div class="form-input">
							...
							<input type="email" placeholder="Correo Electronico" name="inEmail">
						</div>
						...
						<div class="form-input">
							...
							<input type="Password" placeholder="Contraseña"  name="inPassword" required="">
						</div>
						<div class="row mb-3">
							<div class="col-6 d-flex">
								<div class="custom-control custom-checkbox">
									<input type="checkbox" class="custom-control-input" data-bs-toggle="tooltip" id="cb1">
