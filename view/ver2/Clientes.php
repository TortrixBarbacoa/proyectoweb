...
$resultClientes = $usrClass->getClientes();
        ...
        <div class="container">
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <button class="btn btn-success me-md-2" id="btnNuevoUsuario" name="btnNuevoUsuario" type="button"
                    data-bs-toggle="modal" data-bs-target="#formNuevoUsuario">Nuevo Cliente</button>    
            </div>
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <?php 
                while ($fila = mysqli_fetch_array($resultClientes)){
                    ?>
                        <tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="formNuevoUsuario">Bienvenido Nuevo Cliente</h5>
                ...
                <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="nombre_cliente" placeholder="aqui va tu Usuario">
                        <label for="nombre_cliente">Nombre</label>
                    </div>

                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="nit" placeholder="aqui va tu nombre">
                        <label for="nombres">NIT</label>
                    </div>
                   
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="estado" placeholder="aqui va tu apellido">
